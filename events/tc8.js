...
if(!interaction.isButton() && !interaction.isSelectMenu()) return;
      ...
      if(interaction.customId == `create_ticket${s}`) {
        ...
        .setFooter(`Ticketing by OrekiDev`, interaction.guild.iconURL())
        ...
        .setAuthor(`Ticket for: ${interaction.user.tag}`, interaction.user.displayAvatarURL(), `https://discord.io/FSPClip`)
        ...
        .addComponents([,
          ...
          .setURL(`https://discord.io/FSPClip`)
        ])
  ...
  .setRequired(false) // If it's required or not
    ...
    showModal(modal, {
      ...
      interaction: interaction // Show the modal with interaction data.
        ...
        const embed2 = new MessageEmbed()
        .setColor(client.config.color.main)
        .setAuthor(`${interaction.user.tag} ⚡ Staff Member`, interaction.user.displayAvatarURL(), `https://discord.io/FSPClip`)
